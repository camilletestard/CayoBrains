...
# for (gy in 1:length(groupyears)){
  ...
  ###################################################################
  # Merge and save data
  SocialCapital.ALL = SocialCapitalData
# }
...
# selected_regressors = SocialCapital.ALL[,c("id","sex","age","days_between","ordrank","std.numPartnersGroom","loneliness",
#                                            "std.AggIN","std.AggOUT")]
...
# names(selected_regressors)=c("id","sex","age","rank","Grooming","days between","betweenness","eig. centrality",
...
ggsave('Age-Sex group2 Model.tiff')
...
ggsave('integ_shuffled_corr.tiff')
