...
setwd("~/Documents/GitHub/CayoBrains") 
...
setwd("~/Documents/GitHub/CayoBrains/Data")
...
hurricane.df$hurricane.status=1; hurricane.df$hurricane.status[hurricane.df$year<2018]=0;
